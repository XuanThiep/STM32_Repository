...
/* USER CODE BEGIN Header_User_Task1_Function */
/**
 * @brief  Function implementing the User_Task1 thread.
 * @param  argument: Not used
 * @retval None
 */
/* USER CODE END Header_User_Task1_Function */
void User_Task1_Function(void const * argument)
{
